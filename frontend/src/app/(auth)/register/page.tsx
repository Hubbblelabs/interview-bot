      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-16 lg:p-24 relative z-10 bg-white">
        <div className="w-full max-w-sm animate-fade-in-up">
          <div className="mb-10">
            ...
            <h1 className="text-5xl font-black tracking-tighter mb-4 text-primary leading-tight font-sans"> Your Journey Begins Here</h1>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <label className="text-[10px] font-black text-primary/40 uppercase tracking-[0.2em] ml-1">Full Name</label>
              <input
                type="text"
                value={name}
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-primary/40 uppercase tracking-[0.2em] ml-1">Secret Key</label>
              <input
                type="password"
                value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-8 py-5 bg-primary text-white rounded-2xl font-black text-xl hover:bg-black transition-all shadow-2xl flex items-center justify-center gap-4 group"
            >
              {loading ? (
          ...
          <p className="mt-12 text-muted-foreground font-bold tracking-tight">
            ALREADY JOINED?{" "}
            <Link href="/login" className="text-primary hover:underline border-b-2 border-primary">
              SIGN IN
            </Link>
          </p>
        </div>
