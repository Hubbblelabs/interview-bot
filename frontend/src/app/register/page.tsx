...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Extensive Email format validation before sending to backend
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-muted">Start practicing with AI interviews</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 rounded-2xl space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 px-4 bg-white text-black hover:bg-gray-200 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed mt-4"
          >
            {loading ? (
